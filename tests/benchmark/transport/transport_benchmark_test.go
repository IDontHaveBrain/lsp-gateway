...
func BenchmarkTransportLSPClientThroughput(b *testing.B) {
...
func BenchmarkTransportLSPClientConcurrency(b *testing.B) {
...
func BenchmarkTransportLSPClientNotifications(b *testing.B) {
	client := setupBenchmarkLSPClient(b)
	defer teardownBenchmarkLSPClient(b, client)
...
func BenchmarkTransportLSPClientMemoryUsage(b *testing.B) {
	runtime.GC()
...
func BenchmarkTransportLSPClientErrorHandling(b *testing.B) {
	client := setupBenchmarkLSPClient(b)
	defer teardownBenchmarkLSPClient(b, client)
...
func BenchmarkTransportLSPClientStartupShutdown(b *testing.B) {
	ctx := context.Background()
	...
	for i := 0; i < b.N; i++ {
		client := NewBenchmarkMockTransportLSPClient()
...
func setupBenchmarkLSPClient(b *testing.B) transport.LSPClient {
	client := NewBenchmarkMockTransportLSPClient()
	ctx := context.Background()
...
func teardownBenchmarkLSPClient(b *testing.B, client transport.LSPClient) {
...
type BenchmarkMockTransportLSPClient struct {
	active bool
	mu     sync.RWMutex
}

func NewBenchmarkMockTransportLSPClient() *BenchmarkMockTransportLSPClient {
	return &BenchmarkMockTransportLSPClient{active: false}
}

func (m *BenchmarkMockTransportLSPClient) Start(ctx context.Context) error {
	m.mu.Lock()
	defer m.mu.Unlock()
	m.active = true
	return nil
...
func (m *BenchmarkMockTransportLSPClient) Stop() error {
	m.mu.Lock()
	defer m.mu.Unlock()
	m.active = false
	return nil
...
func (m *BenchmarkMockTransportLSPClient) SendRequest(ctx context.Context, method string, params interface{}) (json.RawMessage, error) {
...
func (m *BenchmarkMockTransportLSPClient) SendNotification(ctx context.Context, method string, params interface{}) error {
	return nil
}

func (m *BenchmarkMockTransportLSPClient) IsActive() bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
	return m.active
}
