...
# Works with tests/data/configs/simple-test-repositories.yaml for single repository per language
...
readonly CONFIG_FILE="$PROJECT_ROOT/tests/data/configs/simple-test-repositories.yaml"
readonly BASE_DIR="$PROJECT_ROOT/tests/data/repositories"
