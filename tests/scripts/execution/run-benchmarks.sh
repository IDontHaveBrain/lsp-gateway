...
run_benchmark "LSPValidation" "./tests/benchmark/lsp" "BenchmarkLSPDefinition"
run_benchmark "LSPValidation" "./tests/benchmark/lsp" "BenchmarkLSPReferences"
run_benchmark "LSPValidation" "./tests/benchmark/lsp" "BenchmarkLSPHover"
run_benchmark "LSPValidation" "./tests/benchmark/lsp" "BenchmarkLSPDocumentSymbol"
run_benchmark "LSPValidation" "./tests/benchmark/lsp" "BenchmarkLSPWorkspaceSymbol"
run_benchmark "LSPValidation" "./tests/benchmark/lsp" "BenchmarkLSPConcurrency"
run_benchmark "LSPValidation" "./tests/benchmark/lsp" "BenchmarkLSPMemoryProfile"
run_benchmark "LSPValidation" "./tests/benchmark/lsp" "BenchmarkLSPThroughput"
run_benchmark "LSPValidation" "./tests/benchmark/lsp" "BenchmarkLSPLatencyProfile"
run_benchmark "LSPValidation" "./tests/benchmark/lsp" "BenchmarkLSPLargeFiles"
...
if [[ "${LSP_BENCHMARK_REGRESSION:-0}" == "1" ]]; then
    ...
    run_benchmark "LSPRegression" "./tests/benchmark/lsp" "BenchmarkLSPRegressionDetection"
fi
