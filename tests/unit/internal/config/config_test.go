	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if (err != nil) != tt.wantErr {
				t.Errorf("config.GatewayConfig.Validate() error = %v, wantErr %v", err, tt.wantErr)
			}
		})
	}
}
...
func TestServerConfig_Validate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := tt.config.Validate()
			if (err != nil) != tt.wantErr {
				t.Errorf("config.ServerConfig.Validate() error = %v, wantErr %v", err, tt.wantErr)
			}
		})
	}
}
...
func TestDefaultConfig(t *testing.T) {
	...
	if config == nil {
		t.Fatal("config.DefaultConfig() returned nil")
	}
...
func TestValidateConfig(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if (err != nil) != tt.wantErr {
				t.Errorf("configpkg.ValidateConfig() error = %v, wantErr %v", err, tt.wantErr)
			}
		})
	}
}
...
`
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			config, err := configpkg.LoadConfig(configPath)
			if err == nil {
				err = configpkg.ValidateConfig(config)
			}
...
`
	...
	if err := configpkg.ValidateConfig(config); err != nil {
