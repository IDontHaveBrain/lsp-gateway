...
func (suite *EnhancedE2ETestSuite) configureMockResponses(mockClient *mocks.MockMcpClient) {
	...
	responses := []struct {
		...
		},
		{
			...
			response: json.RawMessage("{\"contents\": {\"kind\": \"markdown\", \"value\": \"" + "```" + "go\\nfunc TestFunction() error\\n" + "```" + "\\n\\nTest function for demonstration\"}}"),
		},
		{
...
func NewResourceContentionResolver() *ResourceContentionResolver {
	return &ResourceContentionResolver{}
}
