...
func setupMemoryTestGateway(t *testing.T, processingDelay time.Duration) *gateway.Gateway {
...
func teardownMemoryTestGateway(t *testing.T, gw *gateway.Gateway) {
