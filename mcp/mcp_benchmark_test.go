...
func setupBenchmarkMCPServer(b *testing.B) *Server {
	config := &ServerConfig{
...
func teardownBenchmarkMCPServer(b *testing.B, server *Server) {
...
func parseMCPMessage(rawMessage string) (*MCPMessage, error) {
...
func processMCPMessage(server *Server, rawMessage string) error {
