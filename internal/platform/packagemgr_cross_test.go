...
func testPackageManager(t *testing.T, pm PackageManager, name, description string) {
...
func getManagerNames(managers []PackageManager) []string {
...
func createMockPackageManagers() []PackageManager {
...
func (m *mockPackageManager) Verify(component string) (*VerificationResult, error) {
