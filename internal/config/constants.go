...
const (
	...
	ENV_LSP_GATEWAY_SCIP_INDEX_PATH       = "LSP_GATEWAY_SCIP_INDEX_PATH"
	ENV_LSP_GATEWAY_SCIP_AUTO_REFRESH     = "LSP_GATEWAY_SCIP_AUTO_REFRESH"
	ENV_LSP_GATEWAY_SCIP_REFRESH_INTERVAL = "LSP_GATEWAY_SCIP_REFRESH_INTERVAL"
	ENV_LSP_GATEWAY_SCIP_FALLBACK_TO_LSP  = "LSP_GATEWAY_SCIP_FALLBACK_TO_LSP"
	ENV_LSP_GATEWAY_SCIP_CACHE_TTL        = "LSP_GATEWAY_SCIP_CACHE_TTL"
