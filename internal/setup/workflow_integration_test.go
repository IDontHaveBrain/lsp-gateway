...
func (m *MockRuntimeDetector) SetMockResult(runtime string, info *RuntimeInfo) {
	m.mockResults[runtime] = info
}

func (m *MockRuntimeDetector) SetDetectAllResult(report *DetectionReport) {
...
func (m *MockRuntimeDetector) SetLogger(logger *SetupLogger) {
	m.logger = logger
}
...
func TestWorkflowIntegration_CompleteSetup(t *testing.T) {
	...
	generator.runtimeDetector = mockDetector
