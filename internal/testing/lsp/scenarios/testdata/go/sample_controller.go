...
import (
	...
	"github.com/kubernetes/kubernetes/pkg/apis/apps/v1"
...
func (dc *DeploymentController) CreateDeployment(ctx context.Context, name string, replicas int32, image string) (*v1.Deployment, error) {
...
func (dc *DeploymentController) GetDeployment(ctx context.Context, name string) (*v1.Deployment, error) {
...
func (dc *DeploymentController) ListDeployments(ctx context.Context) (*v1.DeploymentList, error) {
...
type DeploymentManager interface {
	CreateDeployment(ctx context.Context, name string, replicas int32, image string) (*v1.Deployment, error)
	GetDeployment(ctx context.Context, name string) (*v1.Deployment, error)
