...
func validatePerformanceTargets(b *testing.B, result *BenchmarkResult) {
...
func loadHistoricalPerformanceData(method string) *BenchmarkResult {
...
func detectPerformanceRegressions(historical, current *BenchmarkResult) []string {
...
func savePerformanceData(method string, result *BenchmarkResult) {
