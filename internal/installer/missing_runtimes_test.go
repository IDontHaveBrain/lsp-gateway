...
func TestVerifyRuntimeComponents_MissingGoModules(t *testing.T) {
	...
	installer := createTestInstaller()
	installer.addIssue(result, types.IssueSeverityMedium, types.IssueCategoryDependencies,
...
func TestVerifyRuntimeComponents_MissingPip(t *testing.T) {
	...
	installer := createTestInstaller()
	installer.addIssue(result, types.IssueSeverityHigh, types.IssueCategoryDependencies,
	...
	for server, deps := range dependencyChains {
		t.Run(server, func(t *testing.T) {
			...
			if len(missingDeps) > 0 {
				installer.addIssue(result, types.IssueSeverityCritical, types.IssueCategoryDependencies,
...
func TestVerifyRuntimeInstallation_MissingVerificationFiles(t *testing.T) {
	...
	installer.addIssue(result, types.IssueSeverityMedium, types.IssueCategoryInstallation,
