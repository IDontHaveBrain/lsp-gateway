...
func (s *ServerRegistry) registerDefaults() {
	...
	s.servers[ServerPylsp] = &types.ServerDefinition{
		...
		MinVersion:  "3.9.0",
		InstallCmd:  []string{"pip", "install", "python-lsp-server", "--break-system-packages"},
		VerifyCmd:   []string{"pylsp", "--version"},
		ConfigKey:   "python-lsp",
		Description: "Python LSP server implementation with support for externally-managed environments",
		...
		InstallMethods: []types.InstallMethod{
			{
				...
				Platform:      "all",
				Method:        "pip_install",
				Commands:      []string{"pip", "install", "python-lsp-server", "--break-system-packages"},
			...
			},
			{
				...
				Platform:      "all",
				Method:        "pip_install",
				Commands:      []string{"pip", "install", "--user", "python-lsp-server"},
			...
			},
			{
				...
				Platform:      "all",
				Method:        "pip_install",
				Commands:      []string{"python3", "-m", "pip", "install", "python-lsp-server", "--break-system-packages"},
				Description:   "Install using python3 -m pip with --break-system-packages flag",
				Requirements:  []string{"python >= 3.9.0"},
				PreRequisites: []string{"python3 --version"},
				Verification:  []string{"pylsp", "--version"},
				PostInstall:   []string{},
			},
		},
		...
		InstallMethods: []types.InstallMethod{
			{
				...
				Requirements:  []string{"nodejs >= 20.0.0", "npm"},
