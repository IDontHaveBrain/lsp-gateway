  ...
  constructor() {
    ...
    this.supportedPlatforms = {
      'linux-x64': {
        platform: 'linux',
        arch: 'x64',
        binaryName: 'lspg-linux',
        executable: 'lspg',
        downloadUrl: 'https://github.com/lsp-gateway/lsp-gateway/releases/download/{version}/lspg-linux'
      },
      'win32-x64': {
        platform: 'win32',
        arch: 'x64',
        binaryName: 'lspg-windows.exe',
        executable: 'lspg.exe',
        downloadUrl: 'https://github.com/lsp-gateway/lsp-gateway/releases/download/{version}/lspg-windows.exe'
      },
      'darwin-x64': {
        platform: 'darwin',
        arch: 'x64',
        binaryName: 'lspg-macos',
        executable: 'lspg',
        downloadUrl: 'https://github.com/lsp-gateway/lsp-gateway/releases/download/{version}/lspg-macos'
      },
      'darwin-arm64': {
        platform: 'darwin',
        arch: 'arm64',
        binaryName: 'lspg-macos-arm64',
        executable: 'lspg',
        downloadUrl: 'https://github.com/lsp-gateway/lsp-gateway/releases/download/{version}/lspg-macos-arm64'
      }
    };
  }
