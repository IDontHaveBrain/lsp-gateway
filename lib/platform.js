...
class PlatformInfo {
  constructor() {
    ...
    this.supportedPlatforms = {
      'linux-x64': {
        ...
        downloadUrl: 'https://github.com/lsp-gateway/lsp-gateway/releases/download/v{version}/lsp-gateway-linux'
      },
      'win32-x64': {
        platform: 'win32',
        arch: 'x64',
        ...
        downloadUrl: 'https://github.com/lsp-gateway/lsp-gateway/releases/download/v{version}/lsp-gateway-windows.exe'
      },
      'darwin-x64': {
        platform: 'darwin',
        arch: 'x64',
        ...
        executable: 'lsp-gateway',
        downloadUrl: 'https://github.com/lsp-gateway/lsp-gateway/releases/download/v{version}/lsp-gateway-macos'
      },
      'darwin-arm64': {
        platform: 'darwin',
        arch: 'arm64',
        ...
        executable: 'lsp-gateway',
        downloadUrl: 'https://github.com/lsp-gateway/lsp-gateway/releases/download/v{version}/lsp-gateway-macos-arm64'
      }
    };
  }
  ...
  getCurrentPlatform() {
    ...
    const platformKey = `${this.platform}-${arch}`;
