...
readonly TEST_CONFIG_DIR="./test-configs"
readonly TEST_DATA_DIR="./test-data"
readonly REPO_CACHE_DIR="./test-repositories"
...
display_comprehensive_summary() {
    ...
    [[ -f "$TEST_CONFIG_DIR/ci-test-config.yaml" ]] && echo "      ✓ CI/CD test config" || echo "      ✗ CI/CD test config"
...
EXAMPLES:
    ...
    $0 --minimal                   # Minimal setup for CI/CD
